<?php
    // Assuming $currency is initialized somewhere in your code
    $currency = "RM";
?>
...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
					<h1 class="page-header"><b><p style="color:black;"><b>Add Order</p></h1></b>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Order Added Successfully!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
					...
					<label><p style="color:black;">Select Customer</p></label>
...
?>
                ...
                <div class="form-group">
					<label><p style="color:black;">Description</label><br/>
                 	<input type="text" name="desc" style="width:200px; height: 40px;" /><br/><br/>
				</div>  
                
                <div class="form-group">
					
					<label><p style="color:black;">Date Received</label><br/>
                 	<input type="date" name="date_received" style="width:200px; height: 40px;" /><br/><br/>
				</div>
                
                <div class="form-group">
					
					<label><p style="color:black;">Received By</label>
