...
$balance = 	$data['amount'] - $data['paid'];
 echo "                                 <tr>
											...
											<td>
<a href='addpaymentcustomer.php?id=$data[id]' class='btn btn-success btn-xs'>Payment</a>
<a href='printinvoicecustomer.php?id=$data[id]' class='btn btn-warning btn-xs'>Receipt</a>
";
