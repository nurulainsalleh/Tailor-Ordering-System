 ...
 ?>
    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><p style="color:black;">View Orders</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <style>
    ...
    body {
      color: black; /* Add this line to change text color to black */
    }
  </style>
...
<a href='ssms.php?id=$data[id]' class='btn btn-success btn-xs'>Message</a>
