...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><p style="color:black">Send Messages</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Message Sent Successfully!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
					...
					<label><p style="color:black">Name of Recipient</label>
					...
					<label><p style="color:black">Phone Number</label>
					
					<input name="phone" value='+601XXxXXX' class="form-control"><br/>
...
<div class="form-group">
					...
					<label><p style="color:black">Select a Template</label>
...
?>
                ...
                <div class="form-group">
					...
					<label><p style="color:black">Message</label><br/>
