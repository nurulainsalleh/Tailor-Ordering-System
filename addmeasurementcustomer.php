...
while ($typee = $type->fetch(PDO::FETCH_ASSOC))
{
    ...
    while ($data = $ddaa->fetch(PDO::FETCH_ASSOC))
    {
		...
		echo "<tr><td style='width:100px; height: 40px; margin: 20px;'><img src='$img' width='150px' /></td><td style='width:200px; height: 40px; margin: 20px;'><label>$data[title]</label></td>";
