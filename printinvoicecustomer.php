...
function printContent(el){
    ...
    border-color: #bbb; background-color: #fff;"><br/>
		...
		<div style="text-align:center"><img src="images/logosignin.png" alt="" height="30px"></div>
...
?>
                ...
                <div style='margin-left:40%;'>
                    <b>Payed here</b> 
                    <img src="images/qr.jpg" alt="Image Description" style="width: 100px; margin-left: 150px;">
                </div>
