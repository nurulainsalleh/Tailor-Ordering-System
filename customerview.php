 ...
 ?>
    ...
    <link href="../bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Customers Details & Orders</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$ddaa = $pdo->query("SELECT id, address, fullname, phonenumber, sex FROM customer ORDER BY id");
    while ($data = $ddaa->fetch(PDO::FETCH_ASSOC))
    {
		...
		$measure = '<a href="editmeasurement.php?id='.$data['id'].'" class="btn btn-warning btn-xs">Add Meas</a>';
		}
 ...
 echo "                                 <tr>
											...
											<td>
<a href='orderadd.php?id=$data[id]' class='btn btn-success btn-xs'>Add Order</a>
<a href='partadd.php?id=$data[id]' class='btn btn-success btn-xs'>Add Order Details</a>
$measure
<a href='sms.php?id=$data[id]' class='btn btn-info btn-xs'>Message</a>
