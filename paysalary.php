...
Please select a Category!!!!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
				...
				<input id="desc" type="text" name="desc" class="form-control" style="width:200px; height: 40px;" data-toggle="tooltip" data-placement="right" title="e.g. Month" />
				...
				<div class="form-group">
					...
					<?php echo($currency);?>
					<input id="amount" type="text" name="amount" style="width:200px; height: 40px;" data-toggle="tooltip" data-placement="right" title="Enter the amount of salary for one month" /><br/><br/>
				</div>
